...
During USB mass storage boot, power to the USB ports is switched off for a certain period of time. Some devices may need this parameter changed before they can be used as boot devices.
